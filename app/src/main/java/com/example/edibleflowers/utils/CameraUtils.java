...
public class CameraUtils {
     ...
     * @param expectFps
     */
    public static void openFrontalCamera(int expectFps, int expectWidth, int expectHeight) {
        if (mCamera != null) {
        ...
        Camera.Size size = calculatePerfectSize(p.getSupportedPreviewSizes(),
     ...
     * @param cameraID
     */
    public static void switchCamera(int cameraID, SurfaceHolder holder, int expectWidth, int expectHeight) {
        ...
        releaseCamera();
        // 打开相机
        openCamera(cameraID, CameraUtils.DESIRED_PREVIEW_FPS, expectWidth, expectHeight);
        // 打开预览
